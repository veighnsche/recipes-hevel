...
- validate each barrier against the current zone set
...
- implement `Release` for an active capture session
...
- implement `ConnectToEIS` for a valid InputCapture session
